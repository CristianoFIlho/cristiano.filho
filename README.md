...
```sh
git clone https://github.com/CristianoFIlho/cristiano.filho.git
```
...
Cristiano Filho, – [Link APK]() – 

Distributed under the MIT License. See [LICENSE](LICENSE) for more information.

[https://github.com/CristianoFIlho/cristiano.filho.git](https://github.com/CristianoFIlho/cristiano.filho.git)

## 🧙‍♂️ Contribution

1. Make the _fork_ of the project (<https://github.com/CristianoFIlho/cristiano.filho.git/fork>)
